...
export default {
  ...
  methods: {
    navegarPara() {
      ...
      // this.$router.forward()//avançar no historico de rotas de navegador
      //this.$router.back()//voltar no historico de rotas de navegador
      // this.$router.go(2)//avançar ou voltar no historico de rotas de navegador
